...
from Domains.Results.Views import FeynmanAgentAPIView, ZahraAgent, DavinciAgentAPIView, EinsteinAgentAPIView, HusseinAgentAPIView, FeynmanAgentAPIView, JobsAgentAPIView

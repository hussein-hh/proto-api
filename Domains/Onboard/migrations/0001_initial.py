    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wpm', models.TextField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wpm', models.FilePathField(match='.*\\.json$', null=True, path='uploads', recursive=True)),
                ('ui_report', models.FilePathField(match='.*\\.json$', null=True, path='uploads', recursive=True)),
